...
def draw_axis_alighed_box(_aabox_min, _aabox_max):
    ...
    vtxpt = numpy.array([[_aabox_min[0], _aabox_min[1], _aabox_min[1]], # vtxpt[0]
                         [_aabox_max[0], _aabox_min[1], _aabox_min[1]], # vtxpt[1]
                         [_aabox_min[0], _aabox_max[1], _aabox_min[1]], # vtxpt[2]
                         [_aabox_max[0], _aabox_max[1], _aabox_min[1]], # vtxpt[3]
                         [_aabox_min[0], _aabox_min[1], _aabox_max[1]], # vtxpt[4]
                         [_aabox_max[0], _aabox_min[1], _aabox_max[1]], # vtxpt[5]
                         [_aabox_min[0], _aabox_max[1], _aabox_max[1]], # vtxpt[6]
                         [_aabox_max[0], _aabox_max[1], _aabox_max[1]]] # vtxpt[7]
                        )
