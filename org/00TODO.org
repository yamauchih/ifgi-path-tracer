* Task ifgi path tracer 2011-8-24(Wed)

** top5
*** DONE QIOWidget Checkbox
*** TODO QIOWidget ColorButton
*** TODO GL Light node
*** TODO BUG QtSimpleTabDialog test error
...
*** TODO ifgi parser has no compatibility with obj file,
    but it can load the obj file. Add ifgi parser header, version, and magic.
