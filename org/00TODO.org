* Task ifgi path tracer 2012-1-18(Wed)
...
*** Separate python -> cpp translator and rendering core library
**** python module: ifgi_python_cpp_mod
**** python -> cpp: translator ifgi_python_cpp. Translator has the ifgi_render
**** rendering core: ifgi_cpp_render
*** ifgi_cpp_render.cpp Add framebuffers to the camera
