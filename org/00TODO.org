* Task ifgi path tracer 2011-8-29(Mon)

** top5
*** DONE Fix QtSceneGrpahDialog
*** DONE Background color
*** DONE Trimesh Info
*** TODO bounding box update is broken
*** TODO scenegraph    MaterialNode
*** TODO GL scenegraph GLMaterialNode
...
*** TODO GLTrimeshNode doesnot have set primitive sinve it is not inherited from
    SceneGraph.PritimiveNode
