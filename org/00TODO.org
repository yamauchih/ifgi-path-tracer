* Task ifgi path tracer 2011-8-1(Mon)
...
**** TODO complete Camera set_config_data/get_config_data
**** TODO fix push Update QtExtWidget.py:108
**** DONE listener NodeDialog
**** TODO listener QtSceneGraphWidget
**** TODO listener QtExaminerWidget
