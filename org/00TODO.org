* Task ifgi path tracer 2012-1-3(Tue)
...
*** Back to Dictionary instead of Dict
*** api directory's build system
*** MaterialFactory, base/Dictionary, complete DiffuseMaterial, EnvironmentMaterial
*** send material to cpp code
*** send triangle mesh to cpp code
