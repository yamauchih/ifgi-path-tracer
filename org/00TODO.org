* Task ifgi path tracer 2011-9-12(Mon)
...
** TODO Install Eclipse (on new machine), PySide documentation.
** TODO Add emission to EnvironmentNode
** TODO add check keys list of dictionary
** TODO All Material constructor take mat_dict only
** TODO export the scene
** TODO tracer
