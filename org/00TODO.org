* Task ifgi path tracer 2011-9-2(Fri)
...
*** DONE GL Light node set_config_data/get_config_data
*** DONE BUG broken test
    can not load no volume object (e.g., a plane, one triangle)
...
*** TODO load ifgi file -> ifgiscenereader
         ifgiscenereader -> SceneGraph
         ifgiscenereader -> GLSceneGraph
...
** TODO GLSceneGraphNode
*** TODO GLTriMeshNode config dialog, config_set/get
