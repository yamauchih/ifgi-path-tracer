...
/// \file
/// \brief scene graph
#ifndef IFGI_PATH_TRACER_IFGI_CPP_SCENE_SCENEGRAPH_CPP
#define IFGI_PATH_TRACER_IFGI_CPP_SCENE_SCENEGRAPH_CPP
...
private:
    /// current camera
    Camera m_cur_camera;
    /// SceneGraph root node reference
    ScneGraphNode * m_p_root_node;
};
...
//     def _init__(_nodename, prim){
//         /// constructor
//         \param[in] nodename node name///
//         super(PrimitiveNode, ).__init__(_nodename);

//         this->__primitive = prim
...
//     ///     \param[in]: nodename _nodename for scenegraph visualization///
...
//     ///         raise StandardError, ("Cannot append a child to a _primitive node.");
//     ///     this->__children.append(_child);
...
//         assert(this->__primitive != None);
//         return True


//     def set_primitive(_prim){
//         /// set a primitive.
...
//         ///
//         if this->__primitive == None:
//             raise StandardError, ("No primitive set [" + this->get_classname() +\
//                                       " " + this->get_nodename() + "]");
//         return this->__primitive.get_bbox();
...
//         this->__primitive.set_bbox(_bbox);


//     def print_nodeinfo(_level){
...
//             this->__primitive.get_classname() +\
//             " " + str(this->__primitive.get_bbox());
...
#endif // #ifndef IFGI_PATH_TRACER_IFGI_CPP_SCENE_SCENEGRAPH_CPP
